...
var beforeMixTxt = "Mix Comparison - Unmixed";
var afterMixTxt = "Mix Comparison - Mixed";
if (window.location.href.includes('/?lang=es')) {
  beforeMixTxt = "Comparación de mezcla - Sin Mezclar";
  afterMixTxt = "Comparación de mezcla - Mezclado";
}
